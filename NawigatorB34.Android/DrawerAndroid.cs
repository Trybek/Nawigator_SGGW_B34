...
namespace NawigatorB34.Android
{
    class DrawerAndroid : IDrawer
    {
        ...
        public void DrawPathBetweenFloors()
        {
            ...
            Canvas tempCanvas = new Canvas(bmpFloorStart);
        ...
        public void DrawPathFromRoomToCorridor(Room which, bool finish = false, bool start = true)
        {
                ...
                case 35:
                    {
                        ...
                        tempCanvas.DrawLine((int)which.X, (int)which.Y, 51, (int)which.Y, paint);
                        which.X = 51;
                        break;
                    }
                case 67:
                ...
                case 212:
                    {
                        ...
                        tempCanvas.DrawLine((int)which.X, (int)which.Y, 230, (int)which.Y, paint);
                        which.X = 230;
                        break;
                    }
                case 250:
                ...
                case 291:
                    {
                        ...
                        tempCanvas.DrawLine((int)which.X, (int)which.Y, 265, (int)which.Y, paint);
                        which.X = 265;
                        break;
                    }
                case 347:
                    {
                        ...
                        tempCanvas.DrawLine((int)which.X, (int)which.Y, 375, (int)which.Y, paint);
                        which.X = 375;
                        break;
                    }
                case 390:
                    {
                        ...
                        tempCanvas.DrawLine((int)which.X, (int)which.Y, 410, (int)which.Y, paint);
                        which.X = 410;
                        break;
                    }
                case 428:
                ...
                case 573:
                    {
                        ...
                        tempCanvas.DrawLine((int)which.X, (int)which.Y, 589, (int)which.Y, paint);
                        which.X = 589;
                        break;
                    }
                case 605:
            ...
            switch ((int)which.Y)
            {
                case 35:
                    {
                        tempCanvas.DrawLine((int)which.X, (int)which.Y, (int)which.X, 116, paint);
                        which.Y = 116;
                        break;
                    }
                case 93:
                ...
                case 283:
                    {
                        ...
                        tempCanvas.DrawLine((int)which.X, (int)which.Y, (int)which.X, 306, paint);
                        which.Y = 306;
                        break;
                    }
                case 330:
        ...
        public void DrawPathStartHorizontal(Room roomStart, Room roomFinish, bool start = true)
        {
            ...
            tempCanvas.DrawLine((int)roomStart.X, (int)roomStart.Y, (int)roomStart.X, newY, paint);
            tempCanvas.DrawLine((int)roomFinish.X, (int)roomFinish.Y, (int)roomFinish.X, newY, paint);
            roomStart.Y = newY;
            roomFinish.Y = newY;
        }
        ...
        public object[] DrawPath(Room start, Room finish)
        {
            ...
            if (roomStart.Floor != roomFinish.Floor)
            {
                ...
                Bitmap bitmapStart = BitmapFactory.DecodeResource(context.Resources, idOfMapStart);
                ...
                Bitmap bitmapFinish = BitmapFactory.DecodeResource(context.Resources, idOfMapFinish);
                bmpFloorFinish = Bitmap.CreateBitmap(bitmapFinish.Width, bitmapFinish.Height, Bitmap.Config.Rgb565);

                canvasFinish = new Canvas(bmpFloorFinish);
            ...
            else
            {
                ...
                Bitmap myBitmap = BitmapFactory.DecodeResource(context.Resources, idOfMap);
